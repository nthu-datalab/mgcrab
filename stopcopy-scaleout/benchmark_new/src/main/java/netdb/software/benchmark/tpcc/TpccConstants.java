...
public class TpccConstants {
	...
	// YCSB Constants
//	public static final int YCSB_NUM_RECORDS = 1000000;
	public static final int YCSB_FIELD_COUNT = 10; // including primary key
	public static final int YCSB_CHARS_PER_FIELD = 33; // each char 3 bytes
	public static final String YCSB_ID_FORMAT = "%0" + TpccConstants.YCSB_CHARS_PER_FIELD + "d";
	
	public static final int YCSB_RECORD_PER_PART = 500000;
	public static final int YCSB_MAX_RECORD_PER_PART = 100000000;
