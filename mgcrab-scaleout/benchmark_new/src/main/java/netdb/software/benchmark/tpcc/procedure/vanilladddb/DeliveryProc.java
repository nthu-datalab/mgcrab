...
public class DeliveryProc implements DdStoredProcedure {
	...
	public DeliveryProc(long txNum) {
		this.txNum = txNum;
	}
	...
	public String[] getReadTables() {
		String[] rt = { "new_order", "orders", "order_line" };
		return rt;
	}

	public String[] getWriteTables() {
		String[] wt = { "orders", "order_line", "customer", "new_order" };
		return wt;
	}
