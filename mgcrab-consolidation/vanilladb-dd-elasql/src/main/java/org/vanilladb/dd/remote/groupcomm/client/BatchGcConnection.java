...
public class BatchGcConnection implements ClientP2pMessageListener,
	...
	static {
		...
		String prop = System.getProperty(BatchGcConnection.class.getName()
				+ ".BATCH_SIZE");
		BATCH_SIZE = (prop != null ? Integer.parseInt(prop) : 1);
	}
...
//		System.out.println("Send batch requests: " + spcQueue.size());
