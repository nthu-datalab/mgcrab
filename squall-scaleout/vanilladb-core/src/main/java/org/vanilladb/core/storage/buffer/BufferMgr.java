...
public interface BufferMgr extends TransactionStartListener,
	 ...
	 */
	Buffer pin(BlockId blk, long txNum);
	
	boolean pin(Buffer buf, BlockId expectedBlk, long txNum);
	 ...
	 * @return the buffer pinned to that block
	 */
	Buffer pinNew(String fileName, PageFormatter fmtr, long txNum);
	 ...
	 */
	void unpin(long txNum, Buffer... buffs);
