...
public class ConcurrencyTest {
	...
	public static void init() {
		...
		tx1 = VanillaDb.txMgr().transaction(
				Connection.TRANSACTION_SERIALIZABLE, false);
		tx2 = VanillaDb.txMgr().transaction(
				Connection.TRANSACTION_SERIALIZABLE, false);
		tx3 = VanillaDb.txMgr().transaction(
				Connection.TRANSACTION_REPEATABLE_READ, false);
		tx4 = VanillaDb.txMgr().transaction(
				Connection.TRANSACTION_REPEATABLE_READ, false);
		tx5 = VanillaDb.txMgr().transaction(
				Connection.TRANSACTION_READ_COMMITTED, false);
		tx6 = VanillaDb.txMgr().transaction(
				Connection.TRANSACTION_READ_COMMITTED, false);
