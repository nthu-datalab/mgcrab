...
import static netdb.software.benchmark.tpcc.TransactionType.MIGRATION_ANALYSIS;
...
public class TpccBenchmarker {
	...
	public void startMigration() {
		if (App.myNodeId == 0) {
			...
			try {
				SutConnection spc = TpccBenchmarker.getConnection(0);
				spc.callStoredProc(MIGRATION_ANALYSIS.ordinal());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
...
//			rte = new MicroBenchmarkRte(nextPartition, args);
