...
import org.vanilladb.core.query.algebra.sql.ConstantTest;
...
import org.vanilladb.core.query.planner.opt.AdvanceQueryPlannerTest;
...
@SuiteClasses({ FileTest.class, BufferTest.class, RecordTest.class,
		...
		MaterializeTest.class, TxTest.class, CatalogTest.class,
		QueryTest.class, PlannerTest.class, VerifierTest.class,
		ParseTest.class, ConstantRangeTest.class, BTreeIndexTest.class,
		HashIndexTest.class, ConstantTest.class, HistogramTest.class,
		AdvanceQueryPlannerTest.class, IndexUpdatePlannerTest.class })
